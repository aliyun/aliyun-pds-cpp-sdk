...
namespace PDS
{
    class ALIBABACLOUD_PDS_EXPORT FileGetVideoPreviewPlayInfoRequest: public PdsRequest
    {
    public:
        FileGetVideoPreviewPlayInfoRequest(const std::string& driveID, const std::string& shareID, const std::string& fileID,
            const std::string& category);
        virtual std::shared_ptr<std::iostream> Body() const;

        void setTemplateID(const std::string& templateID);
        void setGetWithoutUrl(bool* getWithoutUrl);
