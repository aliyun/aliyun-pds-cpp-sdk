...
namespace PDS
{
	...
	class ALIBABACLOUD_PDS_EXPORT OutputFormat
	{
	public:
    ...
    class ALIBABACLOUD_PDS_EXPORT CSVOutputFormat : public OutputFormat
    {
    public:
        CSVOutputFormat();
        CSVOutputFormat(
    ...
    class ALIBABACLOUD_PDS_EXPORT JSONOutputFormat : public OutputFormat
    {
    public:
        JSONOutputFormat();
