...
namespace PDS
{
    class ALIBABACLOUD_PDS_EXPORT DirRenameRequest: public PdsRequest
    {
    public:
        DirRenameRequest(const std::string& driveID, const std::string& fileID, const std::string& name,
