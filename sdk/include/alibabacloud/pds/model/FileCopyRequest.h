...
namespace PDS
{
    class ALIBABACLOUD_PDS_EXPORT FileCopyRequest: public PdsRequest
    {
    public:
        FileCopyRequest(const std::string& driveID, const std::string& fileID, const std::string& toParentFileID,
                        bool autoRename);
