...
namespace PDS
{
    class ALIBABACLOUD_PDS_EXPORT FileMoveRequest: public PdsRequest
    {
    public:
        FileMoveRequest(const std::string& driveID, const std::string& fileID, const std::string& toParentFileID,
