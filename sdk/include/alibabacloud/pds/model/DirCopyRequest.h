...
namespace PDS
{
    class ALIBABACLOUD_PDS_EXPORT DirCopyRequest: public PdsRequest
    {
    public:
        DirCopyRequest(const std::string& driveID, const std::string& fileID, const std::string& toParentFileID,
                       bool autoRename);
