...
namespace PDS
{
	...
	class ALIBABACLOUD_PDS_EXPORT InputFormat
	{
	public:
    ...
    class ALIBABACLOUD_PDS_EXPORT CSVInputFormat : public InputFormat
    {
    public:
        CSVInputFormat();
    ...
    class ALIBABACLOUD_PDS_EXPORT JSONInputFormat : public InputFormat
    {
    public:
        JSONInputFormat();
