...
namespace PDS
{
    class ALIBABACLOUD_PDS_EXPORT DirSearchRequest: public PdsRequest
    {
    public:
        DirSearchRequest(const std::string& driveID, const std::string& query,
        ...
        void setReturnTotalCount(bool* returnTotalCount);
