...
namespace PDS
{
    ...
    const std::string ImageThumbnailProcess = "image/resize,w_160/format,jpeg";
    const std::string ImageUrlProcess = "image/resize,w_1920/format,jpeg";
    const std::string VideoThumbnailProcess = "video/snapshot,t_0,f_jpg,w_100,ar_auto";
