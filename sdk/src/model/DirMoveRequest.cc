...
DirMoveRequest::DirMoveRequest(const std::string& driveID, const std::string& fileID, const std::string& toParentFileID,
...
std::shared_ptr<std::iostream> DirMoveRequest::Body() const
{
    Json::Value root;
...
int DirMoveRequest::validate() const
{
    return 0;
}
