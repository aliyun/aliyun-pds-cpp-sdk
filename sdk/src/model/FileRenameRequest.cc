...
FileRenameRequest::FileRenameRequest(const std::string& driveID, const std::string& fileID, const std::string& name,
...
std::string FileRenameRequest::Path() const
{
    return path_;
}

std::shared_ptr<std::iostream> FileRenameRequest::Body() const
{
    Json::Value root;
...
int FileRenameRequest::validate() const
{
    return 0;
}
