...
FileMoveRequest::FileMoveRequest(const std::string& driveID, const std::string& fileID, const std::string& toParentFileID,
...
{
    setPath("/v2/file/move");
}

std::shared_ptr<std::iostream> FileMoveRequest::Body() const
{
    Json::Value root;
...
int FileMoveRequest::validate() const
{
    return 0;
}
